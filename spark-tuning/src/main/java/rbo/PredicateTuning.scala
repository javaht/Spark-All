...
object PredicateTuning {
  ...
  def main( args: Array[String] ): Unit = {
    val sparkConf = new SparkConf().setAppName("PredicateTunning").setMaster("local[*]") //TODO 要打包提交集群执行，注释掉
...
//        |  r.courseid,
//        |  r.coursename
//        |from sale_course l left join course_shopping_cart r  on l.courseid=r.courseid and l.dt=r.dt and l.dn=r.dn  and l.courseid<2
//      """.stripMargin
...
//        |  r.courseid,
//        |  r.coursename
//        |from sale_course l left join course_shopping_cart r  on l.courseid=r.courseid and l.dt=r.dt and l.dn=r.dn
//        |where l.courseid<2
//      """.stripMargin
...
//        |  r.courseid,
//        |  r.coursename
//        |from sale_course l left join course_shopping_cart r  on l.courseid=r.courseid and l.dt=r.dt and l.dn=r.dn  and r.courseid<2
//      """.stripMargin
